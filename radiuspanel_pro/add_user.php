...
<body>
	...
	<div class="container" style="margin-top: 80px; min-height: 510px;">
		<div style="width: 400px; height: 400px; border-radius: 10px; position: absolute; left: 50%; transform: translate(-50%, 0); margin-top: 10px; border: 2px solid darkblue; background-color: white">
